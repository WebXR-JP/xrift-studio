...
const {BufferAttribute,BufferGeometry,Color,ColorManagement,FileLoader,Loader,LinearSRGBColorSpace,SRGBColorSpace,InterleavedBuffer,InterleavedBufferAttribute,LoaderUtils} = await importShared('three');


const _taskCache = new WeakMap();

const WASM_BIN_URL = new URL("/draco_decoder-C32yEggz.wasm", import.meta.url).toString();
const WASM_JS_URL = new URL("/draco_wasm_wrapper-DxJM36Ib.js", import.meta.url).toString();
const JS_URL = new URL("/draco_decoder-fzg4nYZr.js", import.meta.url).toString();

const DRACO_GLTF_CONFIG = {
	js: new URL("/draco_wasm_wrapper-fZCQGLGb.js", import.meta.url).toString(),
	wasm: new URL("/draco_decoder-Z1_iN-Ht.wasm", import.meta.url).toString(),
};
