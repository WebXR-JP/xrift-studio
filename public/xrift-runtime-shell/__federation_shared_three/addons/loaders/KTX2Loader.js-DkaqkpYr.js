...
const {LinearTransfer,Matrix3,SRGBTransfer,SRGBColorSpace: SRGBColorSpace$1,ColorManagement} = await importShared('three');
 ...
 */
({
	...ColorManagement.spaces[ SRGBColorSpace$1 ]});
...
const NORMALIZED_VK_FORMATS = new Set( [ Ue ] );
