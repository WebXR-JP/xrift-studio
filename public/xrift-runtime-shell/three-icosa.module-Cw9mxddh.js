...
const {FileLoader:$a0PbU$FileLoader,TextureLoader:$a0PbU$TextureLoader,GLSL3:$a0PbU$GLSL3,RepeatWrapping:$a0PbU$RepeatWrapping,UniformsLib:$a0PbU$UniformsLib,RawShaderMaterial:$a0PbU$RawShaderMaterial,Loader:$a0PbU$Loader,Vector4:$a0PbU$Vector4,Vector3:$a0PbU$Vector3,Clock:$a0PbU$Clock} = await importShared('three');
...
class $cf098bb13503440d$export$bcc22bf437a07d8f extends $a0PbU$Loader {
    ...
    async load(brushName, onLoad, onProgress, onError) {
        ...
        const loader = new ($a0PbU$FileLoader)(this.manager);
        loader.setPath(this.path);
        loader.setResponseType("text");
        loader.setWithCredentials(this.withCredentials);
        const textureLoader = new ($a0PbU$TextureLoader)(this.manager);
        ...
        materialParams.glslVersion = ($a0PbU$GLSL3);
        ...
        if (materialParams.uniforms.u_MainTex) {
            ...
            mainTex.wrapS = ($a0PbU$RepeatWrapping);
            mainTex.wrapT = ($a0PbU$RepeatWrapping);
            mainTex.flipY = false;
        ...
        if (materialParams.uniforms.u_BumpMap) {
            ...
            bumpMap.wrapS = ($a0PbU$RepeatWrapping);
            bumpMap.wrapT = ($a0PbU$RepeatWrapping);
            bumpMap.flipY = false;
        ...
        if (materialParams.uniforms.u_AlphaMask) {
            ...
            alphaMask.wrapS = ($a0PbU$RepeatWrapping);
            alphaMask.wrapT = ($a0PbU$RepeatWrapping);
            alphaMask.flipY = false;
            materialParams.uniforms.u_AlphaMask.value = alphaMask;
        }
        // inject three.js lighting and fog uniforms
        for(var lightType in ($a0PbU$UniformsLib).lights)materialParams.uniforms[lightType] = ($a0PbU$UniformsLib).lights[lightType];
        for(var fogType in ($a0PbU$UniformsLib).fog)materialParams.uniforms[fogType] = ($a0PbU$UniformsLib).fog[fogType];
        let rawMaterial = new ($a0PbU$RawShaderMaterial)(materialParams);
...
const $cf098bb13503440d$var$tiltBrushMaterialParams = {
    "BlocksBasic": {
        uniforms: {
            ...
            u_ambient_light_color: {
                value: new ($a0PbU$Vector4)(0.3922, 0.3922, 0.3922, 1)
            },
            u_SceneLight_0_color: {
                value: new ($a0PbU$Vector4)(0.7780, 0.8157, 0.9914, 1)
            },
            u_SceneLight_1_color: {
                value: new ($a0PbU$Vector4)(0.4282, 0.4212, 0.3459, 1)
            },
            u_Shininess: {
                value: 0.2
            },
            u_SpecColor: {
                value: new ($a0PbU$Vector3)(0.1960784, 0.1960784, 0.1960784)
            },
            u_fogColor: {
                value: new ($a0PbU$Vector3)(0.0196, 0.0196, 0.0196)
            },
            u_fogDensity: {
                value: 0
            }
    ...
    "BlocksGem": {
        uniforms: {
            ...
            u_Color: {
                value: new ($a0PbU$Vector4)(1, 1, 1, 1)
            },
            u_Shininess: {
                value: 0.9
            },
    ...
    "Comet": {
        uniforms: {
            ...
            u_AlphaMask_TexelSize: {
                value: new ($a0PbU$Vector4)(0.0156, 1, 64, 1)
            },
            u_time: {
                value: new ($a0PbU$Vector4)()
            },
    ...
    "Disco": {
        uniforms: {
            ...
            u_SpecColor: {
                value: new ($a0PbU$Vector3)(0.5147059, 0.5147059, 0.5147059)
            },
            u_fogColor: {
                value: new ($a0PbU$Vector3)(0.0196, 0.0196, 0.0196)
            },
    ...
    "DuctTape": {
        uniforms: {
            ...
            u_SpecColor: {
                value: new ($a0PbU$Vector3)(0.5372549, 0.5372549, 0.5372549)
            },
            u_Shininess: {
                value: 0.414
            },
            ...
            u_BumpMap_TexelSize: {
                value: new ($a0PbU$Vector4)(0.0010, 0.0078, 1024, 128)
            }
        },
    ...
    "Embers": {
        uniforms: {
            ...
            u_ScrollDistance: {
                value: new ($a0PbU$Vector3)(-0.2, 0.6, 0)
            },
    ...
    "Hypercolor": {
        uniforms: {
            ...
            u_SpecColor: {
                value: new ($a0PbU$Vector3)(0.2745098, 0.2745098, 0.2745098)
            },
            u_MainTex: {
    ...
    "Icing": {
        uniforms: {
            ...
            u_SpecColor: {
                value: new ($a0PbU$Vector3)(0.2352941, 0.2352941, 0.2352941)
            },
            u_Shininess: {
                value: 0.1500
            },
    ...
    "LightWire": {
        uniforms: {
            ...
            u_SpecColor: {
                value: new ($a0PbU$Vector3)(0.3455882, 0.3455882, 0.3455882)
            },
            u_time: {
                value: new ($a0PbU$Vector4)()
            },
    ...
    "OilPaint": {
        uniforms: {
            ...
            u_BumpMap_TexelSize: {
                value: new ($a0PbU$Vector4)(0.0020, 0.0020, 512, 512)
            }
        },
    ...
    "ShinyHull": {
        uniforms: {
            ...
            u_SpecColor: {
                value: new ($a0PbU$Vector3)(0.1985294, 0.1985294, 0.1985294)
            },
            u_Shininess: {
                value: 0.7430
            },
    ...
    "Snow": {
        uniforms: {
            ...
            u_ScrollDistance: {
                value: new ($a0PbU$Vector3)(0, -0.3, 0)
            },
            u_ScrollJitterIntensity: {
                value: 0.01
            },
    ...
    "WetPaint": {
        uniforms: {
            ...
            u_SpecColor: {
                value: new ($a0PbU$Vector3)(0.1397059, 0.1397059, 0.1397059)
            },
            u_Shininess: {
                value: 0.85
            },
...
class $ca086492148dd3fa$export$2b011a5b12963d65 {
    constructor(parser, brushPath){
        ...
        this.tiltShaderLoader = new ($cf098bb13503440d$export$bcc22bf437a07d8f)(parser.options.manager);
        this.tiltShaderLoader.setPath(brushPath);
        this.clock = new ($a0PbU$Clock)();
    }
    beforeRoot() {
    ...
    async replaceMaterial(mesh, guidOrName) {
        ...
        mesh.onBeforeRender = (renderer, scene, camera, geometry, material, group)=>{
            if (material?.uniforms?.u_time) {
                ...
                const time = new ($a0PbU$Vector4)(elapsedTime / 20, elapsedTime, elapsedTime * 2, elapsedTime * 3);
            ...
            if (material?.uniforms?.directionalLights?.value) {
                ...
                if (material.uniforms.directionalLights.value[0]) // Color
                {
                    if (material.uniforms.u_SceneLight_0_color) {
                        ...
                        material.uniforms.u_SceneLight_0_color.value = new ($a0PbU$Vector4)(color.r, color.g, color.b, 1);
                    }
                }
                // Shadow Light
                if (material.uniforms.directionalLights.value[1]) // Color
                {
                    if (material.uniforms.u_SceneLight_1_color) {
                        ...
                        material.uniforms.u_SceneLight_1_color.value = new ($a0PbU$Vector4)(color.r, color.g, color.b, 1);
                    }
                }
            }
            // Ambient Light
            if (material?.uniforms?.ambientLightColor?.value) {
                if (material.uniforms.u_ambient_light_color) {
                    ...
                    material.uniforms.u_ambient_light_color.value = new ($a0PbU$Vector4)(colorArray[0], colorArray[1], colorArray[2], 1);
                }
            }
            // Fog
...
export { $ca086492148dd3fa$export$2b011a5b12963d65 as GLTFGoogleTiltBrushMaterialExtension, $cf098bb13503440d$export$bcc22bf437a07d8f as TiltShaderLoader };
