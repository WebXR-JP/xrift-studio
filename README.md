...
[**Web プレビューを開く →**](https://webxr-jp.github.io/xrift-studio/)

GitHub Pages では、サンプルプロジェクトのファイル一覧・コード編集画面・ワールドプレビューをブラウザだけで確認できます。ログイン、ローカルファイル操作、CLI のセットアップと公開はデスクトップ版の機能です。
