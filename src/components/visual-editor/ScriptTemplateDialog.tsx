...
export function ScriptTemplateDialog({
  ...
  return (
    ...
    >
      <div className="flex h-[min(760px,calc(100vh-40px))] w-[min(1120px,calc(100vw-40px))] flex-col overflow-hidden rounded-xl border border-slate-300 bg-white shadow-2xl">
        ...
        <footer className="flex shrink-0 items-center justify-between gap-4 border-t border-slate-200 bg-white px-5 py-3">
