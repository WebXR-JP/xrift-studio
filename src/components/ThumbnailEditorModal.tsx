  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="thumbnail-editor-title"
        className="relative flex h-[min(640px,calc(100dvh-1.5rem))] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-brand-lg animate-scale-in"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between border-b border-zinc-200 bg-zinc-50 px-5 py-3">
          <div>
            <h2 id="thumbnail-editor-title" className="text-sm font-semibold text-zinc-900">サムネイル</h2>
