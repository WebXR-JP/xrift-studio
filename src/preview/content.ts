...
export const creationFlow = [
  ...
  },
  {
    ...
    icon: MousePointer2,
    title: "シーンを組む",
    text: "左のオブジェクト一覧で階層をたどり、中央のビューへ置いていきます。選んだものの細かい設定は、右側でそのまま詰められます。",
  },
  {
    number: "03",
    icon: CirclePlay,
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "はい。ビジュアルエディターなら、素材の取り込みから配置、調整、動作確認、公開まで、コードを書かずに進められます。コードで作りたい人向けのコードエディターも、同じアプリに入っています。",
  },
  {
