...
export const creationFlow = [
  ...
  },
  {
    ...
    icon: MousePointer2,
    title: "シーンを組む",
    text: "Assetsからシーンへ素材を配置し、HierarchyでEntityを選びます。位置や見た目は、右のInspectorで調整できます。",
  },
  {
    number: "03",
    icon: CirclePlay,
    title: "Playで確かめる",
    text: "Playを押すと、その場で歩いたり、仕掛けを操作したりできます。Stopで編集へ戻り、気になったところをすぐ直せます。",
  },
  {
    number: "04",
    icon: Upload,
    title: "XRiftへ公開する",
    text: "「XRiftへ公開」から、タイトル・説明・サムネイルと容量の目安を確認します。準備ができたら、そのままアップロードできます。",
  },
] as const;
...
export const aiPoints = [
  ...
  },
  {
    ...
    text: "地形を彫る、プレハブを置く、マテリアルを変える、スクリプトを書く。エディターでできる操作は、AIからも同じように呼べます。",
  },
  {
    icon: ShieldCheck,
    title: "任せても、戻せる",
    text: "AIが変えた分も、いつものUndoと自動保存の対象です。スクリプトは中身を読んで承認するまで実行されません。",
  },
] as const;
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "はい。ビジュアルエディターで素材を配置・調整し、Playで動きを確かめて公開できます。コードを直接書いて作る場合は、コードエディターを選べます。",
  },
  {
    question: "AIに手伝ってもらえると聞きました。",
    answer:
      "CodexやClaude Codeなどを登録すると、開いているシーンを会話から編集できます。変更はいつものUndoと自動保存の対象になり、スクリプトは承認するまで実行されません。",
  },
  {
    question: "料金はかかりますか？",
    answer:
  ...
  },
  {
    ...
    answer:
      "素材の配置や質感の編集、Playでの確認、ブラウザへの自動保存ができます。.xriftstudioファイルに書き出せば、素材ごとパソコンへ引き継げます。AIクライアントとの接続とXRiftへの公開はデスクトップ版で行います。",
  },
  {
...
export const downloadSteps = {
  ...
  macos: [
    "保存した .dmg を開き、XRift Studioをアプリケーションフォルダーへドラッグします。",
