...
export const WIKI_PAGES: WikiPage[] = [
  ...
  { slug: "assets-and-materials", file: "assets-and-materials.md", title: "アセットと表現", category: "create", order: 3 },
  { slug: "terrain-and-colliders", file: "terrain-and-colliders.md", title: "地形と衝突判定", category: "create", order: 4 },
  { slug: "scripting", file: "scripting.md", title: "Entity に振る舞いを与える", category: "create", order: 5 },
