...
export const WIKI_PAGES: WikiPage[] = [
  ...
  { slug: "visual-editor", file: "visual-editor.md", title: "ビジュアルエディター", category: "create", order: 1 },
  ...
  { slug: "play-mode", file: "play-mode.md", title: "Play / Stopで動作を確認する", category: "publish", order: 0 },
