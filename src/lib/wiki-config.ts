...
export const WIKI_PAGES: WikiPage[] = [
  ...
  { slug: "external-resources", file: "external-resources.md", title: "外部リソースから追加する", category: "create", order: 4 },
  { slug: "assets-and-materials", file: "assets-and-materials.md", title: "アセットと表現", category: "create", order: 5 },
  ...
  { slug: "interactivity", file: "interactivity.md", title: "ノードで動きをつける", category: "create", order: 8 },
  { slug: "interactivity-timeline", file: "interactivity-timeline.md", title: "タイムラインを 1 本つくる", category: "create", order: 9 },
  { slug: "scripting", file: "scripting.md", title: "Entity に振る舞いを与える", category: "create", order: 10 },
