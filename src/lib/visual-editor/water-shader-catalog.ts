...
const COMMON_PARAMETERS: readonly WaterShaderParameter[] = [
  number("uWaveSpeed", "波の速さ", "シーン設定の風に対する倍率です。0で泡や演出も含めて停止します。", "波・さざ波", 0, 2, 0.01),
  ...
  number("uReflectivity", "空の反射", "指定した空色と雲模様を反射方向に応じて描きます。シーン内の物体は映りません。", "反射・透明感", 0, 1, 0.02),
  number("uFresnelPower", "浅い角度の反射", "水面を水平に近い角度から見ると反射が強くなります。", "反射・透明感", 0.5, 8, 0.1),
  number("uGlintStrength", "光のきらめき", "シーンの主Directional Lightから受ける反射の強さです。太陽や月の向きはシーン側で設定します。", "反射・透明感", 0, 4, 0.05),
  ...
  number("uHazeDistance", "遠景がかすむ距離", "大きいほど遠くまで水面の色と模様を保ちます。シーンのFogも別途反映します。", "反射・透明感", 30, 2000, 10),
  ...
  color("uFoamColor", "泡の色", "泡にはシーンの主光と環境光も反映します。"),
  color("uZenithColor", "映り込む天頂の色", "シーンのSkyboxの色に合わせてください。"),
...
const FEATURE_PARAMETERS: Record<Feature, readonly WaterShaderParameter[]> = {
  ...
  CAUSTICS: [
    number("uCausticStrength", "水面の集光模様", "水面に描く疑似コースティクスです。水底のメッシュを照らすものではありません。", "演出", 0, 4, 0.05),
    number("uCausticScale", "集光模様の密度", "細い光の網目の細かさです。", "演出", 0.05, 3, 0.05),
  ],
  STREAKS: [number("uStreakStrength", "風に流れる泡筋", "シーンの風と同じ向きに細長い泡筋を出します。", "演出", 0, 3, 0.05)],
  GLOW: [
    number("uGlowStrength", "夜光の強さ", "泡・波頭・微粒子の発光です。Bloomがなくても光色は見えます。", "演出", 0, 6, 0.05),
    color("uGlowColor", "夜光の色", "シーンの照明に依存しない発光色です。"),
  ],
...
export const WATER_SHADER_CATALOG: readonly WaterShaderCatalogEntry[] = [
  preset({ id: "calm-lake", label: "穏やかな湖", category: "lake", cost: "low",
  ...
  preset({ id: "ocean-waves", label: "波のある海", category: "ocean", cost: "medium",
    description: "標準の海。交差するうねり、細かなさざ波、ちぎれた白波、逆光の透け色を組み合わせます。",
    features: ["交差するうねり", "泡の網目", "逆光の波頭"] }),
  preset({ id: "stylized-toon", label: "トゥーン調の海", category: "stylized", cost: "low", effects: ["TOON"],
  ...
  preset({ id: "deep-swell", label: "外洋の大きなうねり", category: "ocean", cost: "medium",
  ...
  preset({ id: "trade-wind-sea", label: "風が渡る海", category: "ocean", cost: "medium", effects: ["STREAKS"],
  ...
  preset({ id: "coral-shallows", label: "サンゴ礁の浅瀬", category: "tropical", cost: "high", effects: ["SHORE", "CAUSTICS"],
  ...
  preset({ id: "coastal-surf", label: "海岸の打ち寄せる波", category: "coast", cost: "medium", effects: ["SHORE"],
  ...
  preset({ id: "rocky-coast", label: "磯に寄せる波", category: "coast", cost: "high", effects: ["SHORE", "STREAKS"],
  ...
  preset({ id: "storm-sea", label: "嵐の海", category: "weather", cost: "high", effects: ["STREAKS"],
  ...
  preset({ id: "rainy-harbor", label: "雨の港", category: "weather", cost: "high", effects: ["RAIN"],
  ...
  preset({ id: "golden-tide", label: "夕日に染まる海", category: "night", cost: "medium",
  ...
  preset({ id: "moonlit-ocean", label: "月明かりの海", category: "night", cost: "medium",
  ...
  preset({ id: "bioluminescent-bay", label: "夜光虫の入り江", category: "night", cost: "high", effects: ["GLOW", "SHORE"],
  ...
  preset({ id: "anime-ocean", label: "アニメ調の夏の海", category: "stylized", cost: "medium", effects: ["TOON", "CAUSTICS"],
  ...
  preset({ id: "watercolor-sea", label: "水彩画の海", category: "stylized", cost: "medium", effects: ["PIGMENT"],
  ...
  preset({ id: "ink-waves", label: "墨絵の波", category: "stylized", cost: "medium", effects: ["INK", "PIGMENT"],
  ...
  preset({ id: "holographic-sea", label: "ホログラムの海", category: "fantasy", cost: "medium", effects: ["GLOW", "GRID"],
  ...
  preset({ id: "iridescent-sea", label: "虹色の海", category: "fantasy", cost: "medium", effects: ["IRIDESCENT"],
  ...
  preset({ id: "glacial-sea", label: "氷河の海", category: "weather", cost: "high", effects: ["ICE"],
    description: "冷たい青緑の水と、割れ目のある流氷風の模様。模様は水面上の表現で、立体的な氷塊は別のメッシュで配置します。",
