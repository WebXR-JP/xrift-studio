...
export const XRIFT_MCP_TOOLS = [
  ...
  { name: "duplicate_project", surface: "project" },
  { name: "export_project", surface: "project" },
  { name: "import_project", surface: "project" },
  ...
  { name: "plan_spatial_capture", surface: "document" },
  { name: "apply_spatial_capture", surface: "document" },
  { name: "plan_digital_twin", surface: "document" },
  { name: "rank_spatial_prefabs", surface: "document" },
  ...
  { name: "set_mesh_collision", surface: "document" },
  ...
  { name: "list_scene_recipes", surface: "document" },
  ...
  { name: "create_texture_card", surface: "document" },
  ...
  { name: "update_interactivity_asset", surface: "document" },
  { name: "simulate_interactivity_asset", surface: "document" },
  { name: "add_interactivity_graph", surface: "document" },
  { name: "update_interactivity_graph", surface: "document" },
  { name: "delete_interactivity_graph", surface: "document" },
  ...
  { name: "bake_mesh_collider", surface: "local-asset" },
