...
function home(manifest, headings) {
  ...
  return `<section id="${e(headings[0]?.id || "welcome")}" class="guide-welcome" aria-labelledby="welcome-title"><p class="guide-eyebrow">はじめての制作</p><h1 id="welcome-title">配置して、色を変えて、<br>ワールドを作ろう。</h1><p class="guide-lead">ビジュアルエディターを開くところから、保存・Playまで。コードを書かずに、小さな作品を一つ作ります。</p><a class="guide-primary" href="./installation.html">インストールから始める <span aria-hidden="true">→</span></a><a class="guide-secondary" href="./first-world.html">インストール済み：制作を始める →</a><p class="guide-note">制作はPCで行います。このガイドはスマートフォンでも読めます。</p></section>
...
<div class="guide-layout${isHome || isContents ? " guide-layout-home" : ""}"><aside class="guide-sidebar"><nav aria-label="ガイドの目次">${nav}</nav><a class="guide-sidebar-help" href="./contents.html">すべてのページ</a></aside><main id="main" class="guide-main" tabindex="-1">${article}<footer class="guide-footer"><p>このガイドは制作する人向けです。AIの利用やソースコードのビルドは必須ではありません。</p><p><a href="./index.html">ガイドのトップ</a> · <a href="./recovery.html">不具合・説明の問題を報告</a> · <a href="https://github.com/WebXR-JP/xrift-studio/tree/main/docs" target="_blank" rel="noopener noreferrer">開発者向け資料（別のタブ）</a></p><small>確認対象 v${e(manifest.reviewedVersion)} · ${e(manifest.reviewedOn)}</small></footer></main>${hasToc ? `<aside class="guide-toc" aria-label="このページの内容"><strong>このページの内容</strong>${toc(headings)}</aside>` : ""}</div>
<dialog class="guide-search-dialog" aria-labelledby="search-title"><div class="guide-search-top"><h2 id="search-title">使い方を検索</h2><button type="button" data-close-search aria-label="検索を閉じる">閉じる <kbd>Esc</kbd></button></div><label for="guide-search-input">操作・画面の名前・困っていること</label><input id="guide-search-input" type="search" placeholder="例：ラフネス、色 変わらない、保存" autocomplete="off" maxlength="160"><p class="guide-search-status" role="status" aria-live="polite">本文も含めて検索します。検索語は外部へ送信しません。</p><button class="guide-retry" type="button" data-search-retry hidden>読み込みをやり直す</button><ol class="guide-search-results" aria-label="検索結果"></ol><p class="guide-search-footer"><a href="./contents.html">目次から探す</a><span>Tabで結果へ移動・Enterで開く</span></p></dialog>
