...
収録素材と差分の根拠がそろってから、[ショート動画のコピー](./short-video-copy.md) に従って台本を作る。台本はユーザーが一度に確認できる単一の Markdown または JSON とし、次を含める。
...
`./storyboard-schema.md` と `./remotion-patterns.md` は、キット導入前の書き方を残した資料。現在の実装は [xrift-promo-kit](../../xrift-promo-kit/SKILL.md) に従う。
