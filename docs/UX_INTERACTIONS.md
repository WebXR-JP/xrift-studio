...
| F-15 | OBJ / VRM import と静的モデルポーズ | MI-03, MI-05, MI-09, MI-20, MI-36, MI-41, MI-46, MI-56, MI-115, MI-116 | OBJ / VRMをModel Assetとして配置でき、VRMのNode・Bone・Skinned MeshをHierarchyから選び、配置EntityごとのTransform、node別Material、shape key weight、node別の表示 / 非表示とnode単位のCollider追加を保存し、再表示と生成結果で同じ静的状態を復元できる。 |
