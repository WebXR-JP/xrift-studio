...
| F-27 | 公開前パフォーマンス概算 | MI-04, MI-07, MI-27, MI-67 | World / Itemの更新前に初回ロード容量と回線別時間、Assetと実行時VRAMのrange、端末別Studio基準、容量・負荷順の内訳と最適化候補を確認し、推定値の限界を理解した上で同じUpload reviewへ戻れる。 |
