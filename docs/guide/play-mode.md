...
Assetsの追加から「新規スクリプト」を開き、VehicleまたはSeatを選びます。
選択したEntityへ追加し、Playを開始すると車体や椅子が表示されます。
Vehicleの青い座席をクリックすると運転席に座れます。W/Sで前後、A/Dで旋回し、Spaceで降ります。
同乗席とSeat単体は、座って視点を確認できます。Inspectorで速度・旋回速度・座面の高さを変更できます。
