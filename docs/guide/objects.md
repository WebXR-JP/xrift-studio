...
基本形状は**Hierarchy**見出しの**追加 / 操作 → Primitive**から選びます。取り込んだモデルは、**Assets**から中央のシーンへドラッグします。配置するとHierarchyにEntityが増えます。
...
シーンの右クリックは編集用です。基本形状の作成はHierarchyの追加メニュー、モデルの配置はAssetsから行います。
