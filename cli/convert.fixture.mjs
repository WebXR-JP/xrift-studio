...
import { runModelStaticMergeFixtureAssertions } from "../src/lib/visual-editor/model-static-merge.fixture.ts";
...
import { runJevFastAuthoringFixtureAssertions } from "../src/lib/visual-editor/jev-fast-authoring.fixture.ts";
...
try {
  ...
  await runFixtureSuites([
    ...
    ["world play spawn", runWorldPlaySpawnFixtureAssertions],
    ...
    ["jev fast authoring", runJevFastAuthoringFixtureAssertions],
    ...
    ["model static merge", runModelStaticMergeFixtureAssertions],
