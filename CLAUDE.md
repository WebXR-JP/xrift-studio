...
- 作業の種類に応じて `.agents/skills/` のスキルを読む: 機能追加は `xrift-studio-feature`、UX 設計は `xrift-studio-ux`、動作確認・デバッグは `xrift-studio-verify`、MCP でワールドを作る・良くするときは `xrift-world-direction`。
